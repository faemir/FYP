...
struct FtrackPieces
{
	GENERATED_USTRUCT_BODY()
		...
		FtrackPieces() {
			...
			leftCurveLight9.AddDefaulted(4);
			leftCurveLight9[0].SplinePointLoc = { 0, 0, 0 };
			leftCurveLight9[0].SplinePointTan = { 13348.519531, 0, 0 };
			leftCurveLight9[1].SplinePointLoc = { 13348.519531, 0, 0 };
			leftCurveLight9[1].SplinePointTan = { 12372.177734, -3960, 0 };
			leftCurveLight9[2].SplinePointLoc = { 24744.355469, -7920, 0 };
			leftCurveLight9[2].SplinePointTan = { 8990.740234, -9770, 0 };
			leftCurveLight9[3].SplinePointLoc = { 31330.000000, -19540, 0 };
			leftCurveLight9[3].SplinePointTan = { 6585.644531, -11620, 0 };
			...
			rightCurveLight9.AddDefaulted(4);
			rightCurveLight9[0].SplinePointLoc = { 0, 0, 0 };
			rightCurveLight9[0].SplinePointTan = { 13348.519531, 0, 0 };
			rightCurveLight9[1].SplinePointLoc = { 13348.519531, 0, 0 };
			rightCurveLight9[1].SplinePointTan = { 12372.177734, 3960, 0 };
			rightCurveLight9[2].SplinePointLoc = { 24744.355469, 7920, 0 };
			rightCurveLight9[2].SplinePointTan = { 8990.740234, 9770, 0 };
			rightCurveLight9[3].SplinePointLoc = { 31330.000000, 19540, 0 };
			rightCurveLight9[3].SplinePointTan = { 6585.644531, 11620, 0 };
